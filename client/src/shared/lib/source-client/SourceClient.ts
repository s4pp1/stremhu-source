...
import { KodiStreamsService } from './services/KodiStreamsService';
...
import { StremioCatalogsService } from './services/StremioCatalogsService';
...
export class SourceClient {
    ...
    public readonly kodiStreams: KodiStreamsService;
    ...
    public readonly stremioCatalogs: StremioCatalogsService;
    ...
    constructor(config?: Partial<OpenAPIConfig>, HttpRequest: HttpRequestConstructor = FetchHttpRequest) {
        ...
        this.kodiStreams = new KodiStreamsService(this.request);
        ...
        this.stremioCatalogs = new StremioCatalogsService(this.request);
