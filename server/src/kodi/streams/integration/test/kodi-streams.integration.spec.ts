...
import { KodiStreamsCoreService } from '../../core/kodi-streams-core.service';
import { KodiIntegrationController } from '../kodi-streams-integration.controller';

// Mocking KodiStreamsService
jest.mock('../../core/kodi-streams-core.service', () => ({
  KodiStreamsCoreService: jest.fn().mockImplementation(() => ({
    imdbStreams: jest.fn(),
  })),
}));
...
describe('KodiStreams (Integration)', () => {
  ...
  beforeAll(async () => {
    const moduleFixture: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        {
          provide: KodiStreamsCoreService,
