...
import { StremioCoreService } from '../../core/stremio-core.service';
import { StremioIntegrationController } from '../stremio-integration.controller';

// Mocking StremioService
jest.mock('../../core/stremio-core.service', () => ({
  StremioCoreService: jest.fn().mockImplementation(() => ({
    manifest: jest.fn(),
  })),
}));
