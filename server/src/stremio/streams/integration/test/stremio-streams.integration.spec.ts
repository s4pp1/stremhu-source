...
import { StremioStreamsCoreService } from '../../core/stremio-streams-core.service';
import { StremioStreamsIntegrationController } from '../stremio-streams-integration.controller';

// Mocking StremioStreamsService
jest.mock('../../core/stremio-streams-core.service', () => ({
  StremioStreamsCoreService: jest.fn().mockImplementation(() => ({
    streams: jest.fn(),
  })),
}));
...
describe('StremioStreams (Integration)', () => {
  ...
  beforeAll(async () => {
    const moduleFixture: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        {
          provide: StremioStreamsCoreService,
