...
export class UploadRemoveFromTorrents1774800518975 implements MigrationInterface {
  name = 'UploadRemoveFromTorrents1774800518975';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `INSERT INTO "torrents"("tracker", "torrent_id", "info_hash", "updated_at", "created_at", "is_persisted", "last_played_at", "full_download") SELECT "tracker", "torrent_id", "info_hash", "updated_at", "created_at", "is_persisted", "last_played_at", "full_download" FROM "temporary_torrents"`,
    );
