...
export class DiabloTracker1766857127198 implements MigrationInterface {
  name = 'DiabloTracker1766857127198';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "temporary_trackers" ("tracker" varchar CHECK( "tracker" IN ('ncore','bithumen','majomparade','diablo') ) PRIMARY KEY NOT NULL, "username" text NOT NULL, "password" text NOT NULL, "hit_and_run" boolean, "keep_seed_seconds" integer, "download_full_torrent" boolean NOT NULL DEFAULT (0), "order_index" integer NOT NULL DEFAULT (0), "updated_at" datetime NOT NULL DEFAULT (datetime('now')), "created_at" datetime NOT NULL DEFAULT (datetime('now')))`,
    );
    await queryRunner.query(
