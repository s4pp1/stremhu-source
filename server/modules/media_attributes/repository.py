...
from modules.preference_definitions.models import (
    PreferenceDefinitionAttributeModel,
)
from modules.user_preference_definitions.models import (
...
class MediaAttributesRepository:
    ...
    def find_list(
        ...
        if filter:
            if filter.user_id:
                from modules.attribute_exclusions.models import (
